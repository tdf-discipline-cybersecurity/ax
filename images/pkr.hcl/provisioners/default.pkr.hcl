  ...
  provisioner "shell" {
    ...
    inline = [
        ...
        "echo 'Installing pkexec fail2ban ufw net-tools zsh zsh-syntax-highlighting zsh-autosuggestions jq build-essential python3-pip unzip git p7zip libpcap-dev rubygems ruby-dev grc'",
